...
*/
	...
	glBegin(GL_POLYGON);
	glVertex2f(85 +shift, 52);
	glVertex2f(75+shift, 52);
	glVertex2f(78 +shift, 45);
	glVertex2f(82.5+shift, 45);
...
glColor3f(0.160, 0.658, 0.203);
	glBegin(GL_POLYGON);
	glVertex2f(79.5 +shift, 58);
	glVertex2f(79.5+shift , 54);
	glVertex2f(76.5 +shift, 54);
	...
	glBegin(GL_POLYGON);
	glVertex2f(79.5+shift , 58);
	glVertex2f(79.5+shift , 52);

	glVertex2f(81 +shift, 52);
	glVertex2f(81+shift , 58);
